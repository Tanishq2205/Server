...
// Example of inserting FAQ data
db.collection('faqs').insertMany([
  { question: "What is your service?", answer: "We provide educational services." },
  { question: "How can I contact support?", answer: "You can contact support via email." },
]);

// Example of inserting client data (if not already there)
